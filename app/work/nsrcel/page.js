...
const page = () => {
  ...
  return (
    ...
    <Head>
        ...
        <meta
          name="description"
          content="It provides incubation for business and social ventures, focusing on sustainable mobility, tech innovations, and women entrepreneurs, boosting India’s startup ecosystem."
        />
      </Head>
      <Navbar />
